...
/**
 * Shared bank verification dialog component for ACH microdeposit verification.
 * Used by both Mahad and Dugsi admin interfaces.
 *
 * Admins enter the 6-digit SM code from the student/family's bank statement
 * to verify their bank account for ACH payments.
 */
export function VerifyBankDialog({
  ...
  const handleVerify = async () => {
    ...
    startTransition(async () => {
      try {
        const result = await onVerify(paymentIntentId, descriptorCode)
  ...
  const userType = program === 'MAHAD' ? 'student/parent' : 'family'
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription className="pt-2">
            ...
            statement for <strong>{contactEmail}</strong>.
            <br />
            ...
            <div className="flex gap-2">
              ...
              <div className="space-y-1">
                ...
                <ol className="ml-4 list-decimal space-y-1 text-blue-700 dark:text-blue-300">
                  <li>Ask the {userType} to check their bank statement</li>
