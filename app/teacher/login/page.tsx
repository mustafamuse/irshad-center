...
import { validateTeacherLogin } from './actions'

function LoginForm() {
  const searchParams = useSearchParams()
  const redirectTo = searchParams.get('redirect') || '/teacher/attendance'
  ...
  const submitPin = (fullPin: string) => {
    startTransition(async () => {
      const result = await validateTeacherLogin(fullPin, redirectTo)
      if (!result.success) {
