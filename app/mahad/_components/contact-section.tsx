        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <motion.a
                href={`https://wa.me/1${contactInfo.whatsapp}?text=${encodeURIComponent("As-salaam-alaikum Ustadh Mustafa! I'm interested in learning more about Irshad Center's programs and class schedules.")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-between gap-6 rounded-2xl bg-[#25D366]/5 p-6 transition-all hover:bg-[#25D366]/10"
                whileHover={{ x: 5 }}
                transition={{ type: 'spring', stiffness: 300 }}
              >
                <div className="flex items-center gap-6">
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[#25D366] shadow-sm transition-transform group-hover:scale-110">
                  ...
                  <div>
                    <h3 className="text-xl font-medium text-[#25D366]">
                      Chat with Us on WhatsApp
                    </h3>
                    <p className="mt-1 text-gray-600">
                      Fastest way to reach us - We'll respond quickly!
                    </p>
                  </div>
                </div>
                <div className="rounded-full bg-[#25D366] px-6 py-3 text-base font-medium text-white shadow-lg transition-transform hover:scale-105">
                  Click to Message
                </div>
              </motion.a>
